        ...
        <div style={{ display: 'flex', gap: isMobile ? 28 : 56, alignItems: 'flex-start', flexDirection: isMobile ? 'column' : 'row' }}>
          ...
          <div style={{ flex: '1 1 300px', minWidth: 0 }}>
            ...
            <h1 style={{
              ...
              fontSize: isMobile ? 'clamp(28px, 8vw, 38px)' : 'clamp(32px, 4vw, 52px)',
          ...
          <div style={{ flex: '1 1 320px', minWidth: 0, width: isMobile ? '100%' : 'auto' }}>
            <div style={{
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                <input placeholder="Tu nombre completo *" value={form.nombre} onChange={e => setForm(p => ({ ...p, nombre: e.target.value }))} required style={inputStyle} />
                <input placeholder="Correo electrónico *" type="email" value={form.correo} onChange={e => setForm(p => ({ ...p, correo: e.target.value }))} required style={inputStyle} />
                ...
                <button type="submit" disabled={sending} style={{
                  ...
                  marginTop: 4, boxShadow: '0 4px 16px rgba(176,137,104,0.4)', width: '100%',
                }}>
